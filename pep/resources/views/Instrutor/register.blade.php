    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Cadastro de Instrutor</div>

                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('instrutor.register') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('lastname') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="lastname" type="text" class="form-control" name="lastname" placeholder="Sobrenome" value="{{ old('lastname') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('registro') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="registro" type="text" class="form-control" name="registro" placeholder="Nº Registro" value="{{ old('lastname') }}" required autofocus>
